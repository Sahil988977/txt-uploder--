...
pwimg = "https://graph.org/file/b47dc959d1b44270c8165-4fc4ce1a4840f294ed.jpg"
#ytimg = "https://graph.org/file/b47dc959d1b44270c8165-4fc4ce1a4840f294ed.jpg"
cpimg = "https://graph.org/file/b47dc959d1b44270c8165-4fc4ce1a4840f294ed.jpg"  
...
OWNER_ID = 6478225349 # Replace with the actual owner's user ID
...
keyboard = InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton("🇮🇳ʙᴏᴛ ᴍᴀᴅᴇ ʙʏ🇮🇳" ,url=f"https://t.me/Idkit6858") ],
                    [
                    InlineKeyboardButton("🔔ᴜᴘᴅᴀᴛᴇ ᴄʜᴀɴɴᴇʟ🔔" ,url="https://t.me/Idkit6858") ],
                    [
                    InlineKeyboardButton("🦋ғᴏʟʟᴏᴡ ᴜs🦋" ,url="https://t.me/Idkit6858")                              
                ],           
            ]
      )
...
async def help_command(client: Client, msg: Message):
    help_text = (
        "`/start` - Start the bot⚡\n\n"
        "`/luciferr` - Download and upload files (sudo)🎬\n\n"
...
@bot.on_message(filters.command(["luciferr"]))
